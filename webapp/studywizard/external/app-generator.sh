...
cd app_generator
API_VERSION="v1"
wget -O generate_app_remote.py http://funf-in-a-box.appspot.com/generator-script
export DROPBOX_APP_KEY=$(curl http://metadata/computeMetadata/$API_VERSION/instance/attributes/DROPBOX_APP_KEY -H "X-Google-Metadata-Request: True")
export DROPBOX_APP_SECRET=$(curl http://metadata/computeMetadata/$API_VERSION/instance/attributes/DROPBOX_APP_SECRET -H "X-Google-Metadata-Request: True")
